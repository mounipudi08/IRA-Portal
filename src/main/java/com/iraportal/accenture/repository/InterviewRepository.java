...
public interface InterviewRepository extends JpaRepository<Interview, Long>{
	...
	List<Interview> getInterviewsByEmail(@Param("email") String email);
	...
	@Query("Select i from Interview i where i.profile.id = :id")
    List<Interview> getInterviewsByProfileId(@Param("id") int id);
}
